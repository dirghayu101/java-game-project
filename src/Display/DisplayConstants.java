...
public class DisplayConstants {
    ...
    public static final String USER_CHOICE_PROMPT = "static/display/userChoicePrompt.txt";
    public static final String SPACER = "static/display/spacer.txt";
    public static final String WELCOME_SCREEN = "static/display/welcomeScreen.txt";
    public static final String CONFIRM_USER_CHOICE = "static/display/confirmChoice.txt";
